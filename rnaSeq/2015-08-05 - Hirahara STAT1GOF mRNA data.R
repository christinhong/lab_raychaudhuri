...
# I'm glad it worked. You should be able to print your genes in any colour you can think of by adding 'col' argument to your 'text' function. You could also plot the points of any colour on top of your smear plot. Analogous to the way you use the 'text' function: points(x=gene.labels$logCPM, y=gene.labels$logFC, cex=1, col="red").  Hope it helps, Aliaksei


# Looking up genes on ensembl.org:
# ENSG00000137959.11	11514	1183	13606	13793	2694	685	1573	2067	4309	0.2888237851	2.7359326144	7.4873662634	4.26680949702916E-007	0.0085457794
# IFI44L (chr1): IFN-induced protein 44-like

# ENSG00000112874.5	193	248	343	234	116	72	191	106	122	0.1179380525	1.6087394277	2.3875072555	2.69575815460375E-006	0.0172739548
#  NUDT12 (chr5): nudix (nucleoside diphosphate linked moiety X)-type motif 12

# ENSG00000151640.8	177	392	1424	153	236	170	61	71	159	0.2847131808	2.3522436109	3.1384845626	1.04736123385868E-005	0.0339638801
# DPYSL4 (chr10): dihydropyrimidinase-like 4

# ENSG00000225783.2	547	157	2018	800	431	270	321	95	79	0.2948552227	2.3768567214	3.9044051912	1.15098954505187E-005	0.0339638801
# MIAT (chr22): myocardial infarction associated transcript (non-protein coding)

# ENSG00000137965.6	4038	616	3764	3431	1758	496	527	752	1860	0.2456131981	2.1125738056	5.8871296185	1.59356024770286E-005	0.0413834117
# IFI44 (chr1): IFN-induced protein 44 

# ENSG00000113645.9	10	55	12	21	74	261	324	412	90	0.3433961753	-2.7634533925	1.8194076535	1.82043001020843E-005	0.0428946852
# WWC1 (chr5): WW and C2 domain containing 1 

# ENSG00000270906.1	779	762	1525	806	1263	8988	2248	7892	10196	0.2476293987	-2.2160930842	6.5819232832	2.1237748009539E-005	0.0472622484
# RP11-475J5.6 (chr5)

# Interesting.  I'm not sure if it's reliable, but it's reassuring that both IFI44L and IFI44 came up as DEGs (and both downregulated in cases).  They seem to be involved in anti-viral immunity, though the literature is sparse - 64 PubMed hits for IFI44, 28 for IFI44L.  But a good number of them show links with STAT1.

# Publication linking IFI44 to prolonged unphosphorylated STAT1 expression: Cheon, H., & Stark, G. R. (2009). Unphosphorylated STAT1 prolongs the expression of interferon-induced immune regulatory genes. Proceedings of the National Academy of Sciences, 106(23), 9373–9378. http://doi.org/10.1073/pnas.0903487106
# Publication with ChIP-seq of STAT1:STAT2 dimers to promoter of IFI44: Hernandez, J. M., Elahi, A., Clark, W., Humphries, L. A., Wang, J., Achille, A., … Shibata, D. (2015). The Tumor Suppressive Effects of HPP1 Are Mediated Through JAK-STAT-Interferon Signaling Pathways. DNA and Cell Biology, 34(8), 541–9. http://doi.org/10.1089/dna.2014.2730
# Publication on hypomethylation of IFN-regulated genes in naive CD4+ T cells in lupus patients, including STAT1 and IFI44L: Coit, P., Jeffries, M., Altorok, N., Dozmorov, M. G., Koelsch, K. A., Wren, J. D., … Sawalha, A. H. (2013). Genome-wide DNA methylation study suggests epigenetic accessibility and transcriptional poising of interferon-regulated genes in naïve CD4+ T cells from lupus patients. Journal of Autoimmunity, 43, 78–84. http://doi.org/10.1016/j.jaut.2013.04.003
...
# From https://rstudio-pubs-static.s3.amazonaws.com/85101_ad12a157e52d4fbb8361219c0c8b50c1.html and limma user guide:
...
plotMDS(v, labels = 1:9, main = "MDS plot")
...
# Umm...that seems a bit much.  Basically everything looks like a DEG.
